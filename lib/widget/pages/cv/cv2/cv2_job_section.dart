...
class CV2WorkPart extends pw.StatelessWidget {



  UserModel? userModel;
  List<Experience2>? work_list = [];

  CV2WorkPart({this.userModel}){
    work_list = userModel!.works!.workModels?.map((e) {

      return Experience2(experienceModel: e,);
    },).toList();
  }
              ...
              pw.Row(
                  ...
                  children: [
                   pw.Container(
                    ...
                    pw.Expanded(
                      child: pw.Text("سوابغ شغلی",style: cv2_head1, textDirection: pw.TextDirection.rtl)
                    )
                  ]
              ),
              ...?work_list
