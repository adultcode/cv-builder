...
class Education2 extends pw.StatelessWidget {
  ...
  Education2({this.educationModel});
        ...
        child: pw.Column(
            ...
            children: [
              ...
              pw.Row(
                  ...
                  children: [
                    pw.Text("${educationModel!.start_date!} - ${educationModel!.end_date!}",
                        textDirection: pw.TextDirection.rtl,
                        style:cv2_body1),

                    pw.Text("${educationModel!.grade!} - ${educationModel!.title!}",
                        textDirection: pw.TextDirection.rtl,
                        style:cv2_body2)
                  ]
              ),
              ...
              pw.SizedBox(height: PdfPageFormat.cm*0.15),
              pw.Text(educationModel!.description!,
                  textDirection: pw.TextDirection.rtl,
                  style:cv2_body1)
            ]
        )
