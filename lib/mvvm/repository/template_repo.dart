...
class TemplateRepository{
  ...
  Future<List<TemplateModel>> getTemplates()async{
    ...
    template_list.add(TemplateModel(id: 1,title: 'first',img_path: 'screen/1.PNG',selected: false,is_vip: false));
    template_list.add(TemplateModel(id: 2,title: 'second',img_path: 'screen/2.PNG',selected: false,is_vip: false));
