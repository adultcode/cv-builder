...
class TemplateRepository{
  ...
  Future<List<TemplateModel>> getTemplates()async{
    ...
    template_list.add(TemplateModel(id: 1,title: 'first',img_path: 'assets/screen/1.PNG',selected: false,is_vip: false));
    template_list.add(TemplateModel(id: 2,title: 'second',img_path: 'assets/screen/2.png',selected: false,is_vip: false));
